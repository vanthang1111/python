...
def process_order(request):
        ...
        try:
            ...
            if name and email and address and city and state and mobile and country:
                ...
                payment = Payment({
                    ...
                    "redirect_urls": {
                        "return_url": request.build_absolute_uri('paypal_return/'),
                ...
                if payment.create():
                    ...
                    # Xóa sản phẩm từ giỏ hàng (tùy thuộc vào cách bạn đã triển khai hàm updateItem)
    ...
    print(status)
    return render(request, 'app/checkout.html', {"status": status})
